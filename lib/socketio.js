                    ...
                    p(t, [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                var e = '' + t.type;
                                return (
                                    (t.type !== l.BINARY_EVENT && t.type !== l.BINARY_ACK) || (e += t.attachments + '-'),
                                    t.nsp && '/' !== t.nsp && (e += t.nsp + ','),
                                    null != t.id && (e += t.id),
                                    ...
                                    if ('string' == typeof t)
                                        (e = this.decodeString(t)).type === l.BINARY_EVENT || e.type === l.BINARY_ACK
                                            ? ((this.reconstructor = new m(e)),
                                              0 === e.attachments && o(a(n.prototype), 'emit', this).call(this, 'decoded', e))
                                            : o(a(n.prototype), 'emit', this).call(this, 'decoded', e);
                                    else {
                                        if (!d.isBinary(t) && !t.base64) throw new Error('Unknown type: ' + t);
                                        if (!this.reconstructor) throw new Error('got binary data when not reconstructing a packet');
                                        (e = this.reconstructor.takeBinaryData(t)) &&
                                            ((this.reconstructor = null), o(a(n.prototype), 'emit', this).call(this, 'decoded', e));
                                    }
                                },
                            },
                            {
                ...
                v = (function (t) {
                    ...
                    function v(t, e) {
                        ...
                        !(function (t, e) {
                            ...
                            (n.backoff = new d({ min: n.reconnectionDelay(), max: n.reconnectionDelayMax(), jitter: n.randomizationFactor() })),
                                ...
                                value: function () {
                                    ...
                                    if (this.backoff.attempts >= this._reconnectionAttempts)
                                        ...
                                        var r = setTimeout(function () {
                                            e.skipReconnect ||
                                                (i(u(v.prototype), 'emit', t).call(t, 'reconnect_attempt', e.backoff.attempts),
                                                e.skipReconnect ||
                                                    e.open(function (n) {
                                                        n
                                                            ? ((e._reconnecting = !1),
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    (o.options.compress = !1 !== this.flags.compress),
                                        'function' == typeof n[n.length - 1] && ((this.acks[this.ids] = n.pop()), (o.id = this.ids++));
                ...
                v = (function (t) {
                    ...
                    function l(t) {
                        ...
                        return (
                            ...
                            (e.hostname = n.hostname || ('undefined' != typeof location ? location.hostname : 'localhost')),
                    ...
                    return (
                        ...
                        (n = [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var t;
                                    if (this.opts.rememberUpgrade && l.priorWebsocketSuccess && -1 !== this.transports.indexOf('websocket'))
                                        t = 'websocket';
                                    else {
                                    ...
                                    try {
                                        ...
                                        try {
                                            if (this.opts.extraHeaders)
                                                for (var o in (e.setDisableHeaderCheck && e.setDisableHeaderCheck(!0), this.opts.extraHeaders))
                ...
                return o && u instanceof Blob
                    ...
                    : i &&
                      (u instanceof ArrayBuffer ||
                          ((c = u), 'function' == typeof ArrayBuffer.isView ? ArrayBuffer.isView(c) : c && c.buffer instanceof ArrayBuffer))
                    ? e
